...
const JSON_PATHS = {
    products: '/products/thubee-farmery/json/products.json',
    customers: '/products/thubee-farmery/json/customers.json',
    sellers: '/products/thubee-farmery/json/sellers.json',
    orders: '/products/thubee-farmery/json/orders.json',
};
const STATUS_LABEL = {
